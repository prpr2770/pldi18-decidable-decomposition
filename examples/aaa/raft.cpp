...
bool raft::ext__system__req_replicate_entry_from_log(int ix, bool isrecover, const node& recovernode){
    ...
    rejected = (bool)___ivy_choose(2,"fml:rejected",0);
    {
        {
            int loc__previx;
    loc__previx = (int)___ivy_choose(0,"loc:previx",1342);
            {
                {
                    int loc__prevt;
    loc__prevt = (int)___ivy_choose(0,"loc:prevt",1341);
                    {
                        {
                            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1340);
                            {
                                loc__0 = ext__localstate__get_term();
                                {
                                    int loc__t;
    loc__t = (int)___ivy_choose(0,"loc:t",1339);
                                    {
                                        loc__t = loc__0;
                                        {
                                            __strlit loc__v;
                                            {
                                                ...
                                                {
                                                    int loc__logt;
    loc__logt = (int)___ivy_choose(0,"loc:logt",1337);
                                                    {
                                                        if((localstate__is_leader() && hist__filled(localstate__myhist,ix))){
                                                            {
                                                                ...
                                                                {
                                                                    msg loc__0;
    loc__0.m_kind = (msgkind)___ivy_choose(7,"loc:0",1336);
    loc__0.m_ix = (int)___ivy_choose(0,"loc:0",1336);
    loc__0.m_term = (int)___ivy_choose(0,"loc:0",1336);
    loc__0.m_logt = (int)___ivy_choose(0,"loc:0",1336);
    loc__0.m_prevlogt = (int)___ivy_choose(0,"loc:0",1336);
    loc__0.m_isrecover = (bool)___ivy_choose(2,"loc:0",1336);
                                                                    {
                                                                        loc__0 = ext__msg_append_send(loc__t, loc__v, loc__logt, ix, loc__prevt, isrecover, recovernode);
                                                                        {
                                                                            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1335);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1335);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1335);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1335);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1335);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1335);
                                                                            {
                                                                                loc__m = loc__0;
        ...
        if(!localstate__is_leader()){
            {
                ...
                {
                    bool loc__0;
    loc__0 = (bool)___ivy_choose(2,"loc:0",1343);
                    {
            ...
            {
                int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1344);
                {
                    loc__0 = ext__localstate__get_term();
...
void raft::ext__node__iter__next(node__iter__t& x){
        ...
        {
            bool loc__0;
    loc__0 = (bool)___ivy_choose(2,"loc:0",1334);
            {
...
void raft::ext__hist__strip(hist& h, int ix){
    ...
    loc__dummy_ent.ent_logt = (int)___ivy_choose(0,"loc:dummy_ent",1346);
            {
                {
                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1345);
                    {
...
void raft::ext__shim__handle_keepalive(int t){
    {
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1347);
            {
                loc__0 = ext__localstate__get_term();
                if((loc__0 < t)){
                    {
        ...
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1348);
            {
                loc__0 = ext__localstate__get_term();
                if((loc__0 == t)){
                    {
...
void raft::ext__shim__broadcast(const msg& m){
    ...
    loc__0.is_end = (bool)___ivy_choose(2,"loc:0",1351);
            {
                loc__0 = ext__node__iter__create(__num0());
                {
                    node__iter__t loc__iter;
    loc__iter.is_end = (bool)___ivy_choose(2,"loc:iter",1350);
                    {
                        loc__iter = loc__0;
...
void raft::ext__system__announce_candidacy(){
    {
        ...
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1357);
            {
                loc__0 = ext__localstate__get_term();
                {
                    int loc__t;
    loc__t = (int)___ivy_choose(0,"loc:t",1356);
                    {
                        loc__t = loc__0;
                        if(hist__filled(localstate__myhist,0)){
                            {
                                {
                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1355);
                                    int loc__1;
    loc__1 = (int)___ivy_choose(0,"loc:1",1355);
                                    {
                                        loc__0 = ext__hist__get_next_ix(localstate__myhist);
                                        loc__1 = ext__index__prev(loc__0);
                                        {
                                            int loc__ix;
    loc__ix = (int)___ivy_choose(0,"loc:ix",1354);
                                            {
                                                loc__ix = loc__1;
                                                {
                                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1353);
                                                    {
                                                        loc__0 = ext__hist__get_logt(localstate__myhist, loc__ix);
                                                        {
                                                            int loc__logt;
    loc__logt = (int)___ivy_choose(0,"loc:logt",1352);
                                                            {
                                                                loc__logt = loc__0;
...
void raft::ext__send_appended_reply_msg(const node& leader, int t, const node& n, int ix, bool isrecover){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1358);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1358);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1358);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1358);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1358);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1358);
            {
...
void raft::ext__shim__handle_appended_reply_msg(int t, const node& replier, int ix, bool isrecover){
    {
        {
            bool loc__ok;
    loc__ok = (bool)___ivy_choose(2,"loc:ok",1367);
            {
                loc__ok = true;
                {
                    int loc__nextreportix;
    loc__nextreportix = (int)___ivy_choose(0,"loc:nextreportix",1366);
                    {
                        ...
                        if((loc__ok && isrecover && hist__filled(localstate__myhist,0))){
                            {
                                int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1362);
                                int loc__1;
    loc__1 = (int)___ivy_choose(0,"loc:1",1362);
                                {
                                    loc__0 = ext__hist__get_next_ix(localstate__myhist);
                                    loc__1 = ext__index__prev(loc__0);
                                    {
                                        int loc__lastusedix;
    loc__lastusedix = (int)___ivy_choose(0,"loc:lastusedix",1361);
                                        {
                                            loc__lastusedix = loc__1;
                                            if((ix < loc__lastusedix)){
                                                {
                                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1360);
                                                    bool loc__1;
    loc__1 = (bool)___ivy_choose(2,"loc:1",1360);
                                                    {
                                                        loc__0 = ext__index__next(ix);
                                                        loc__1 = ext__system__req_replicate_entry_from_log(loc__0, isrecover, replier);
                                                        {
                                                            bool loc__rejected;
    loc__rejected = (bool)___ivy_choose(2,"loc:rejected",1359);
                                                            {
                                                                loc__rejected = loc__1;
                                                                ivy_assume(!loc__rejected, "raft.ivy: line 842");
                                                            }
                                                        }
                                                    }
                                                }
                        ...
                        {
                            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1363);
                            {
                                loc__0 = ext__localstate__get_term();
...
void raft::ext__shim__handle_rqst_vote_nolog(int t, const node& cand){
    {
        {
            bool loc__ok;
    loc__ok = (bool)___ivy_choose(2,"loc:ok",1368);
            {
...
void raft::ext__system__report_commits(int firstix, int lastix){
    {
        int loc__ix;
    loc__ix = (int)___ivy_choose(0,"loc:ix",1371);
        {
            loc__ix = firstix;
...
void raft::ext__localstate__increase_term_by_nodeid(){
    {
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1372);
            int loc__1;
    loc__1 = (int)___ivy_choose(0,"loc:1",1372);
            int loc__2;
    loc__2 = (int)___ivy_choose(0,"loc:2",1372);
            {
...
void raft::ext__hist__append(hist& h, int ix, int logt, __strlit v){
    ...
    loc__new_ent.ent_logt = (int)___ivy_choose(0,"loc:new_ent",1370);
            {
                loc__new_ent.ent_logt = logt;
                loc__new_ent.ent_value = v;
                {
                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1369);
                    {
                        loc__0 = ext__index__next(ix);
...
void raft::ext__shim__handle_vote_cand_msg(const node& cand, int t, const node& voter){
    {
        {
            bool loc__ok;
    loc__ok = (bool)___ivy_choose(2,"loc:ok",1414);
            {
                loc__ok = true;
...
void raft::ext__send_keepalive(int t){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1376);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1376);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1376);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1376);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1376);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1376);
            {
...
void raft::ext__shim__handle_nack(const node& n, int t, int ix){
    {
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1380);
            {
                loc__0 = ext__localstate__get_term();
                if(((loc__0 == t) && localstate__is_leader() && hist__filled(localstate__myhist,ix))){
                    {
                        bool loc__isrecover;
    loc__isrecover = (bool)___ivy_choose(2,"loc:isrecover",1379);
                        {
                            loc__isrecover = true;
                            {
                                bool loc__0;
    loc__0 = (bool)___ivy_choose(2,"loc:0",1378);
                                {
                                    loc__0 = ext__system__req_replicate_entry_from_log(ix, loc__isrecover, n);
                                    {
                                        bool loc__rejected;
    loc__rejected = (bool)___ivy_choose(2,"loc:rejected",1377);
                                        {
                                            loc__rejected = loc__0;
                                            ivy_assume(!loc__rejected, "raft.ivy: line 646");
                                        }
                                    }
                                }
                            }
...
void raft::ext__send_rqst_vote_m_nolog(const node& cand, int t){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1381);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1381);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1381);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1381);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1381);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1381);
            {
    ...
    {
        {
            ...
            {
                node__iter__t loc__0;
    loc__0.is_end = (bool)___ivy_choose(2,"loc:0",1416);
                {
                    loc__0 = ext__node__iter__create(__num0());
                    {
                        node__iter__t loc__i;
    loc__i.is_end = (bool)___ivy_choose(2,"loc:i",1415);
                        {
                            loc__i = loc__0;
                            while(!loc__i.is_end){
                                {
...
void raft::ext__send_rqst_vote_msg(const node& cand, int logt, int ix, int t){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1382);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1382);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1382);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1382);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1382);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1382);
            {
...
bool raft::ext__system__req_append_new_entry(__strlit v){
    ...
    rejected = (bool)___ivy_choose(2,"fml:rejected",0);
    {
        {
            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1388);
            {
                loc__0 = ext__localstate__get_term();
                {
                    int loc__t;
    loc__t = (int)___ivy_choose(0,"loc:t",1387);
                    {
                        loc__t = loc__0;
                        {
                            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1386);
                            {
                                loc__0 = ext__hist__get_next_ix(localstate__myhist);
                                {
                                    int loc__ix;
    loc__ix = (int)___ivy_choose(0,"loc:ix",1385);
                                    {
                                        loc__ix = loc__0;
                                        if(localstate__is_leader()){
                                            {
                                                ...
                                                {
                                                    bool loc__isrecover;
    loc__isrecover = (bool)___ivy_choose(2,"loc:isrecover",1384);
                                                    {
                                                        loc__isrecover = false;
                                                        {
                                                            node loc__dummy_recovernode;
                                                            {
                                                                ...
                                                                ivy_assume(!rejected, "raft.ivy: line 692");
                                                            }
                                                        }
                                                    }
                                                }
...
void raft::ext__send_nack(const node& leader, int t, int ix){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1391);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1391);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1391);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1391);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1391);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1391);
            {
                loc__m.m_kind = nack;
                loc__m.m_term = t;
                loc__m.m_node = n;
...
void raft::ext__localstate__add_replier(int ix, const node& replier){
    {
        if(((replierslog__end(localstate__my_repliers) < ix) || (replierslog__end(localstate__my_repliers) == ix))){
            {
                int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1392);
                {
                    loc__0 = ext__index__next(ix);
...
void raft::ext__shim__handle_append_entries(const msg& m){
    {
        {
            int loc__t;
    loc__t = (int)___ivy_choose(0,"loc:t",1406);
            {
                loc__t = m.m_term;
                {
                    int loc__ix;
    loc__ix = (int)___ivy_choose(0,"loc:ix",1405);
                    {
                        loc__ix = m.m_ix;
                        {
                            int loc__logt;
    loc__logt = (int)___ivy_choose(0,"loc:logt",1404);
                            {
                                loc__logt = m.m_logt;
                                {
                                    __strlit loc__v;
                                    {
                                        ...
                                        {
                                            int loc__prevt;
    loc__prevt = (int)___ivy_choose(0,"loc:prevt",1402);
                                            {
                                                loc__prevt = m.m_prevlogt;
                                                {
                                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1401);
                                                    {
                                                        loc__0 = ext__localstate__get_term();
                                                        {
                                                            int loc__node_term;
    loc__node_term = (int)___ivy_choose(0,"loc:node_term",1400);
                                                            {
                                                                loc__node_term = loc__0;
                                                                {
                                                                    bool loc__ok;
    loc__ok = (bool)___ivy_choose(2,"loc:ok",1399);
                                                                    {
                                                                        loc__ok = true;
                                                                        loc__ok = (loc__ok && !localstate__is_leader());
                                                                        ...
                                                                        if((!(loc__ix == 0) && loc__ok)){
                                                                            {
                                                                                {
                                                                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1396);
                                                                                    {
                                                                                        loc__0 = ext__index__prev(loc__ix);
                                                                                        {
                                                                                            bool loc__has_previous;
    loc__has_previous = (bool)___ivy_choose(2,"loc:has_previous",1395);
                                                                                            {
                                                                                                ...
                                                                                                if(!loc__has_previous){
                                                                                                    {
                                                                                                        {
                                                                                                            int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1394);
                                                                                                            {
                                                                                                                loc__0 = ext__index__prev(loc__ix);
                                                                                ...
                                                                                if(!hist__logtix(localstate__myhist,loc__ix,loc__logt)){
                                                                                    {
                                                                                        if((loc__ix == 0)){
                                                                                        ...
                                                                                        else {
                                                                                            {
                                                                                                {
                                                                                                    int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1398);
                                                                                                    {
                                                                                                        loc__0 = ext__index__prev(loc__ix);
                                                                                                        {
                                                                                                            int loc__previx;
    loc__previx = (int)___ivy_choose(0,"loc:previx",1397);
                                                                                                            {
                                                                                                                loc__previx = loc__0;
...
void raft::ext__send_vote_cand_msg(const node& n, int t, const node& cand){
    {
        {
            msg loc__m;
    loc__m.m_kind = (msgkind)___ivy_choose(7,"loc:m",1375);
    loc__m.m_ix = (int)___ivy_choose(0,"loc:m",1375);
    loc__m.m_term = (int)___ivy_choose(0,"loc:m",1375);
    loc__m.m_logt = (int)___ivy_choose(0,"loc:m",1375);
    loc__m.m_prevlogt = (int)___ivy_choose(0,"loc:m",1375);
    loc__m.m_isrecover = (bool)___ivy_choose(2,"loc:m",1375);
            {
...
void raft::ext__shim__handle_rqst_vote(int logt, int ix, int t, const node& cand){
    {
        {
            bool loc__ok;
    loc__ok = (bool)___ivy_choose(2,"loc:ok",1411);
            {
                loc__ok = true;
                if(hist__filled(localstate__myhist,0)){
                    {
                        int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1410);
                        int loc__1;
    loc__1 = (int)___ivy_choose(0,"loc:1",1410);
                        {
                            loc__0 = ext__hist__get_next_ix(localstate__myhist);
                            loc__1 = ext__index__prev(loc__0);
                            {
                                int loc__lastix;
    loc__lastix = (int)___ivy_choose(0,"loc:lastix",1409);
                                {
                                    loc__lastix = loc__1;
                                    {
                                        int loc__0;
    loc__0 = (int)___ivy_choose(0,"loc:0",1408);
                                        {
                                            loc__0 = ext__hist__get_logt(localstate__myhist, loc__lastix);
                                            {
                                                int loc__lastlogt;
    loc__lastlogt = (int)___ivy_choose(0,"loc:lastlogt",1407);
                                                {
